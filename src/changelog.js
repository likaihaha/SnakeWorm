...
const LOGS = [
    {
        ...
        date: '2026-05-04',
        items: [
            '海洋雪宝珠 — 新增白色微粒宝珠，半径2px（绿宝珠的1/4）',
            '微弱光晕效果：像深海中飘落的有机碎屑一样闪烁',
            '极低重力(0.003) + 水平摆动(0.3)，营造海洋雪飘落的氛围',
            '高生成概率(50%) + 大量上限(20)，形成持续飘落的背景效果',
            '分数1分：纯装饰性环境元素，不触发特殊效果',
        ]
    },
    {
        version: 'v1.85',
        date: '2026-05-03',
        items: [
            '可挖掘墙壁系统 — 区域间的泥墙，由28px单元格组成，厚度≈12节虫虫长度',
            '虫虫碰墙时嘴巴一张一合啃泥，挖掘产生泥块飞溅粒子特效',
            '墙壁内随机嵌入宝珠，挖穿后释放宝珠作为奖励',
            '每格独立HP+裂纹视觉反馈，完全挖穿后墙壁消失',
            '墙壁同时覆盖所有相邻区域间的过渡',
        ]
    },
    {
        ...
        date: '2026-05-03',
        items: [
            'Phase 2 功能补全 — 护理恢复 + 侦察兵机制完整接入',
            '护理恢复：幼体受伤后变灰变慢（轻伤0.8x/重伤0.6x），母体靠近60px内自动治疗，每2秒恢复1级，绿色脉冲特效+恢复音效',
            '侦察兵：好奇性格幼体主动探索200~600px远处宝珠，到达后闪烁提示母体，并在母体附近画方向箭头指示宝珠方位',
            '勇敢挡刀音效：幼体挡刀时播放出生音效提示',
            '修复config.js多余闭括号语法错误',
        ]
    },
    {
        version: 'v1.80',
