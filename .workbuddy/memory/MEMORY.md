...
## 当前版本
- v1.70: 组变换控制器 - 选中组后显示绿色包围框，移动/缩放/旋转均基于组中心，点击组内元素自动选中组
- v1.69: 多选变换控制器 - Shift+多选后显示绿色大包围框，可整体平移+基于各自中心缩放/旋转
- v1.68: 编辑器多选修复 - 框选坐标考虑平移缩放+Shift+点击元素不再误触框选
- v1.67: Phase 1 亲子情感升级 - 孵化动画+死亡动画+撒娇系统(孵化5阶段、幼体撒娇/庆祝/死亡4阶段、5个亲子音效、出生奖励3秒无敌)
- v1.66: 尖角+圆角双重填充 - 勾选尖角时圆角三角形仍保留，尖角三角形叠加在外侧
- v1.65: 尖角填充模式 - 勾选后外侧边缘延长线相交形成尖角三角形，拐角≤90°自动回退圆角
- v1.64: 折线拐角三角形补丁 - 外角缺口用三角形填满，叉积判断拐角朝向
- v1.63: 折线可变宽度细分修复 - 每段20等分消除拐角裂痕+路径渐变平滑过渡
- v1.62: 编辑器路径渐变+粗细节点共存 - widthNodes和pathGradient同时生效，可变宽度梯形段使用渐变色插值
- v1.61: 地图扩大5×5倍+相机系统 - 800×600视口+4000×3000世界地图，相机平滑跟随虫虫头部(lerp)，网格瓦片平铺，出生点(400,2800)左下方偏高，宝珠集中在出生点附近(半径1200)
- v1.60: 全身碰撞 - 虫虫全身与敌人全身碰撞，头部撞敌人才双向伤害
